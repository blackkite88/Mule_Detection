"""
Step 5v2 — Improved Feature Matrix Assembly
Joins ALL feature tables: static + txn_basic + txn_advanced + graph +
txn_additional + behavior patterns.
Handles categoricals, drops leakage, and saves train/test.
"""
import polars as pl
...
# ── Drop IDs, dates, PII, duplicate join keys ────────────────────────
DROP_COLS = [
...
train_df.write_parquet(FEAT / "train_features_v2.parquet")
test_df.write_parquet(FEAT / "test_features_v2.parquet")
print("\n✓ features/train_features_v2.parquet saved")
print("✓ features/test_features_v2.parquet saved")
