...
PRUNED_FEATURES = [
    ...
    "avg_txn_interval_days", "balance_turnover_30d", "txn_count_90d",
    "unique_cp_90d", "total_credit_90d", "total_debit_90d",
    "credit_debit_ratio_90d", "balance_turnover_90d",
    
    # Behavior (Only top ones)
    "avg_balance", "balance_volatility", "weekend_txn_ratio",
    "night_txn_ratio", "round_amount_ratio",
    
    # Graph & Network
    "in_degree", "out_degree", "total_volume_in", "total_volume_out",
    "eigenvector_centrality", "pagerank", "hub_score", "authority_score",
    "clustering_coeff", "community_id", "k_core", "network_ratio",
    "triangle_count", "bridge_score", "reciprocity",
    
    # Enhanced Features - Target Encodings
    "te_branch_id_mean", "te_city_tier_mean", "te_risk_category_mean",
    "te_mcc_mean", "te_mcc_std",
    
    # Enhanced Features - Frequency Encodings
    "fe_branch_id", "fe_city_tier", "fe_risk_category", "fe_mcc",
    
    # Enhanced - Cross Features
    "graph_pagerank_te_mcc", "graph_hub_te_branch", "bal_volatility_mcc_std",
    "account_age_in_degree", "fe_city_auth_score",
    
    # Enhanced - Temporal Interactions
    "txn_velocity_30d", "amount_velocity_30d", "credit_spike_7d",
    "debit_spike_7d", "cp_velocity_30d",
    
    # Enhanced - Counterparty Patterns
    "max_amount_per_cp", "avg_amount_per_cp", "cp_concentration",
    "n_unique_counterparties", "entropy_of_counterparties",
    "top_1_cp_ratio", "top_3_cp_ratio",
    
    # Enhanced - Benford's Law
    "benford_mad", "benford_1_freq", "benford_2_freq", "benford_8_freq",
    "benford_9_freq",
    
    # SHAP RECOMMENDED FEATURES (NEW IN V5)
